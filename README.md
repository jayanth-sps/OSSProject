...
- To develop shell scripting skills

- To automate system-level tasks

- To analyze logs for basic security insights
...
- Working with shell scripting concepts (loops, conditions, variables)
...
jayanth.24mei10013@vitbhopal.ac.in
